...
public class Owner {
    ...
    public Owner(String name, String surname, String mail, String phone, String address, String idDniType, String dniNumber, String idPersonType, String password, String birthDay) {
        this.name = name;
